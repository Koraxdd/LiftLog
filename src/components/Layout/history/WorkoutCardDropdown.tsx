            ...
            <div className="flex flex-col gap-4 p-6">
                {workout.exercises.map(exercise => (
                    <div key={exercise.id}>
                        ...
                        <div className="grid grid-cols-[3rem_1fr_1fr_1fr] md:grid-cols-4 gap-6 text-text-muted font-medium text-sm bg-surface items-center px-4 py-3">
                        ...
                        {exercise.sets.map(set => {
                            ...
                            return (
                                <div key={set.id} className="grid grid-cols-[3rem_1fr_1fr_1fr] md:grid-cols-4 gap-6 font-semibold border-t border-subtle py-6 px-4">
