...
export default function Hero() {
    return (
        <section className="flex flex-col justify-center items-center text-center px-6 gap-7">
            ...
            <div className="flex flex-col justify-center items-center gap-6">
                <h1 className="text-5xl/15 font-semibold">Transform Your <span className="text-brand">Fitness Journey</span></h1>
